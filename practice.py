...
def repeat_string(string,n):
    print string * n
repeat_string('Ballonicorn',3)
#--------------4---------------#


#--------------5---------------#
def print_sign(n):
    print type(n)==int, 'Higher than 0' if int(n) > 0 elif 'Lower than 0' else 'Zero'
print_sign(-3)  # need to figure out how to get rid of boolean 
#--------------5---------------#
...
print full_title('Baloonicorn')
#--------------1---------------#

#--------------2---------------#
def write_title(recepient_name, job_title, sender_name):
    return "Dear {} {}, I think you are amazing! Sincerely, {}".format(job_title,recepient_name,sender_name)
print write_title('Baloonicorn')
#--------------2---------------#
